<?php get_header(); ?>
    <section class="container" role="main">
        <header class="header text-center text-secondary mt-4 mb-3">
            <h1 class="entry-title my-0"><?php pll_e("Resources"); ?></h1>
        </header>

        <div class="row justify-content-center mb-4">
            <div class="col-lg-5 col-md-6">
                <h5 class="text-center"><?php pll_e("Community Partners Resources"); ?></h5>
            ...
            <div class="col-lg-5 col-md-6">
                <h5 class="text-center"><?php pll_e("Vendor Resources"); ?></h5>
                <div class="list-group resource-list mb-3">
                    <?php
                    // WP_Query arguments
                    $args = array(
