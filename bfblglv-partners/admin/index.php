    ...
    <body>
        <div class="site-wrapper">
            <div class="container">
                ...
                <h1 class="title">Partner Administration</h1>

				<div class="text-center">
	                <div class="btn-group btn-group-lg">
						<a href="/admin/applications.php" class="btn btn-primary">Applications</a>
						<a href="/admin/renewals.php" class="btn btn-success">Renewals</a>
	                </div>
	            </div>
            </div>
