...
function addPartnerData($user_id, $partner) {
	...
	if ($partner->category === "farm") {
		...
		update_field("field_field_56b2f83125877", $partner->products_greens, $user_id);
		$partner->other_products_greens = explode("|", $partner->other_products_greens);
		update_field("field_field_56b2f8ca25878", $partner->other_products_greens, $user_id);
		$partner->products_roots = explode("|", $partner->products_roots);
		update_field("field_field_56b2f91725879", $partner->products_roots, $user_id);
		$partner->other_products_roots = explode("|", $partner->other_products_roots);
		update_field("field_field_56b2f9212587a", $partner->other_products_roots, $user_id);
		$partner->products_seasonal = explode("|", $partner->products_seasonal);
		update_field("field_field_56b2f98c2587b", $partner->products_seasonal, $user_id);
		$partner->other_products_seasonal = explode("|", $partner->other_products_seasonal);
		update_field("field_field_56b2f98e2587c", $partner->other_products_seasonal, $user_id);
		$partner->products_melons = explode("|", $partner->products_melons);
		update_field("field_field_56b2fa2b9dc34", $partner->products_melons, $user_id);
		$partner->other_products_melons = explode("|", $partner->other_products_melons);
		update_field("field_field_56b2fa429dc35", $partner->other_products_melons, $user_id);
		$partner->products_herbs = explode("|", $partner->products_herbs);
		update_field("field_field_56b2fa8832a98", $partner->products_herbs, $user_id);
		$partner->other_products_herbs = explode("|", $partner->other_products_herbs);
		update_field("field_field_56b2fab532a99", $partner->other_products_herbs, $user_id);
		$partner->products_berries = explode("|", $partner->products_berries);
		update_field("field_field_56b2fae5983e5", $partner->products_berries, $user_id);
		$partner->other_products_berries = explode("|", $partner->other_products_berries);
		update_field("field_field_56b2faf2983e6", $partner->other_products_berries, $user_id);
		$partner->products_small_fruits = explode("|", $partner->products_small_fruits);
		update_field("field_field_56b2fb1c37150", $partner->products_small_fruits, $user_id);
		$partner->other_products_small_fruits = explode("|", $partner->other_products_small_fruits);
		update_field("field_field_56b2fb1f37151", $partner->other_products_small_fruits, $user_id);
		$partner->products_grains = explode("|", $partner->products_grains);
		update_field("field_field_56b2fba45cdb9", $partner->products_grains, $user_id);
		$partner->other_products_grains = explode("|", $partner->other_products_grains);
		update_field("field_field_56b2fcfd5cdcb", $partner->other_products_grains, $user_id);
		$partner->products_value_added = explode("|", $partner->products_value_added);
		update_field("field_field_56b2fbb95cdba", $partner->products_value_added, $user_id);
		$partner->other_products_value_added = explode("|", $partner->other_products_value_added);
		update_field("field_field_56b2fd355cdcc", $partner->other_products_value_added, $user_id);
		$partner->products_flowers = explode("|", $partner->products_flowers);
		update_field("field_field_56b2fbbf5cdbb", $partner->products_flowers, $user_id);
		$partner->other_products_flowers = explode("|", $partner->other_products_flowers);
		update_field("field_field_56b2fd739f715", $partner->other_products_flowers, $user_id);
		$partner->products_plants = explode("|", $partner->products_plants);
		update_field("field_field_56b2fbc55cdbc", $partner->products_plants, $user_id);
		$partner->other_products_plants = explode("|", $partner->other_products_plants);
		update_field("field_field_56b2fe565cd34", $partner->other_products_plants, $user_id);
		$partner->products_ornamentals = explode("|", $partner->products_ornamentals);
		update_field("field_field_56b2fbcb5cdbd", $partner->products_ornamentals, $user_id);
		$partner->other_products_ornamentals = explode("|", $partner->other_products_ornamentals);
		update_field("field_field_56b2fe6d5cd35", $partner->other_products_ornamentals, $user_id);
		$partner->products_syrups = explode("|", $partner->products_syrups);
		update_field("field_field_56b2fbd15cdbe", $partner->products_syrups, $user_id);
		$partner->other_products_syrups = explode("|", $partner->other_products_syrups);
		update_field("field_field_56b2fe855cd36", $partner->other_products_syrups, $user_id);
		$partner->products_dairy = explode("|", $partner->products_dairy);
		update_field("field_field_56b2fbda5cdbf", $partner->products_dairy, $user_id);
		$partner->other_products_dairy = explode("|", $partner->other_products_dairy);
		update_field("field_field_56b2fe9e5cd37", $partner->other_products_dairy, $user_id);
		$partner->products_meat = explode("|", $partner->products_meat);
		update_field("field_field_56b2fbe35cdc0", $partner->products_meat, $user_id);
		$partner->other_products_meat = explode("|", $partner->other_products_meat);
		update_field("field_field_56b2feb15cd38", $partner->other_products_meat, $user_id);
		$partner->products_poultry = explode("|", $partner->products_poultry);
		update_field("field_field_56b2fbe95cdc1", $partner->products_poultry, $user_id);
		$partner->other_products_poultry = explode("|", $partner->other_products_poultry);
		update_field("field_field_56b2fec25cd39", $partner->other_products_poultry, $user_id);
		$partner->products_agritourism = explode("|", $partner->products_agritourism);
		update_field("field_field_56b2fbf65cdc2", $partner->products_agritourism, $user_id);
		$partner->other_products_agritourism = explode("|", $partner->other_products_agritourism);
		update_field("field_field_56b2fee45cd3a", $partner->other_products_agritourism, $user_id);
		$partner->products_fibers = explode("|", $partner->products_fibers);
		update_field("field_field_56b2fc695cdc3", $partner->products_fibers, $user_id);
		$partner->other_products_fibers = explode("|", $partner->other_products_fibers);
		update_field("field_field_56b2ff0c51a5f", $partner->other_products_fibers, $user_id);
		$partner->products_artisinal = explode("|", $partner->products_artisinal);
		update_field("field_field_56b2fc765cdc4", $partner->products_artisinal, $user_id);
		$partner->other_products_artisinal = explode("|", $partner->other_products_artisinal);
		update_field("field_field_56b2ff1151a60", $partner->other_products_artisinal, $user_id);
		$partner->products_liquids = explode("|", $partner->products_liquids);
		update_field("field_field_56b2fc855cdc5", $partner->products_liquids, $user_id);
		$partner->other_products_liquids = explode("|", $partner->other_products_liquids);
		update_field("field_field_56b2ff1751a61", $partner->other_products_liquids, $user_id);
		$partner->products_educational = explode("|", $partner->products_educational);
		update_field("field_field_56b2fcab5cdc6", $partner->products_educational, $user_id);
		$partner->other_products_educational = explode("|", $partner->other_products_educational);
		update_field("field_field_56b2ffa051a62", $partner->other_products_educational, $user_id);
		$partner->products_baked = explode("|", $partner->products_baked);
		update_field("field_field_56b2fcbb5cdc7", $partner->products_baked, $user_id);
		$partner->other_products_baked = explode("|", $partner->other_products_baked);
		update_field("field_field_56b2ffc051a63", $partner->other_products_baked, $user_id);
		$partner->products_seeds = explode("|", $partner->products_seeds);
		update_field("field_field_56b2fcd05cdc9", $partner->products_seeds, $user_id);
		$partner->other_products_seeds = explode("|", $partner->other_products_seeds);
		update_field("field_field_56b2ffdd51a64", $partner->other_products_seeds, $user_id);
		$partner->products_misc = explode("|", $partner->products_misc);
		update_field("field_field_56b2fcdd5cdca", $partner->products_misc, $user_id);
		$partner->other_products_misc = explode("|", $partner->other_products_misc);
		update_field("field_field_56b2fff651a65", $partner->other_products_misc, $user_id);
		...
		if ($partner->is_wholesaler) {
			...
			update_field("field_field_56c1653b5566e", $partner->ws_products_greens, $user_id);
			$partner->other_ws_products_greens = explode("|", $partner->other_ws_products_greens);
			update_field("field_field_56c1653e5566f", $partner->other_ws_products_greens, $user_id);
			$partner->ws_products_roots = explode("|", $partner->ws_products_roots);
			update_field("field_field_56c17154e540e", $partner->ws_products_roots, $user_id);
			$partner->other_ws_products_roots = explode("|", $partner->other_ws_products_roots);
			update_field("field_field_56c17156e540f", $partner->other_ws_products_roots, $user_id);
			$partner->ws_products_seasonal = explode("|", $partner->ws_products_seasonal);
			update_field("field_field_56c1715ae5410", $partner->ws_products_seasonal, $user_id);
			$partner->other_ws_products_seasonal = explode("|", $partner->other_ws_products_seasonal);
			update_field("field_field_56c1715ce5411", $partner->other_ws_products_seasonal, $user_id);
			$partner->ws_products_melons = explode("|", $partner->ws_products_melons);
			update_field("field_field_56c17160e5412", $partner->ws_products_melons, $user_id);
			$partner->other_ws_products_melons = explode("|", $partner->other_ws_products_melons);
			update_field("field_field_56c17163e5413", $partner->other_ws_products_melons, $user_id);
			$partner->ws_products_herbs = explode("|", $partner->ws_products_herbs);
			update_field("field_field_56c17167e5414", $partner->ws_products_herbs, $user_id);
			$partner->other_ws_products_herbs = explode("|", $partner->other_ws_products_herbs);
			update_field("field_field_56c1716de5415", $partner->other_ws_products_herbs, $user_id);
			$partner->ws_products_berries = explode("|", $partner->ws_products_berries);
			update_field("field_field_56c17173e5416", $partner->ws_products_berries, $user_id);
			$partner->other_ws_products_berries = explode("|", $partner->other_ws_products_berries);
			update_field("field_field_56c17177e5417", $partner->other_ws_products_berries, $user_id);
			$partner->ws_products_small_fruits = explode("|", $partner->ws_products_small_fruits);
			update_field("field_field_56c17248e5418", $partner->ws_products_small_fruits, $user_id);
			$partner->other_ws_products_small_fruits = explode("|", $partner->other_ws_products_small_fruits);
			update_field("field_field_56c1724ce5419", $partner->other_ws_products_small_fruits, $user_id);
			$partner->ws_products_grains = explode("|", $partner->ws_products_grains);
			update_field("field_field_56c1724fe541b", $partner->ws_products_grains, $user_id);
			$partner->other_ws_products_grains = explode("|", $partner->other_ws_products_grains);
			update_field("field_field_56c1725be541c", $partner->other_ws_products_grains, $user_id);
			$partner->ws_products_value_added = explode("|", $partner->ws_products_value_added);
			update_field("field_field_56c1725ee541d", $partner->ws_products_value_added, $user_id);
			$partner->other_ws_products_value_added = explode("|", $partner->other_ws_products_value_added);
			update_field("field_field_56c17261e541e", $partner->other_ws_products_value_added, $user_id);
			$partner->ws_products_flowers = explode("|", $partner->ws_products_flowers);
			update_field("field_field_56c17265e541f", $partner->ws_products_flowers, $user_id);
			$partner->other_ws_products_flowers = explode("|", $partner->other_ws_products_flowers);
			update_field("field_field_56c17268e5420", $partner->other_ws_products_flowers, $user_id);
			$partner->ws_products_plants = explode("|", $partner->ws_products_plants);
			update_field("field_field_56c172dbe5426", $partner->ws_products_plants, $user_id);
			$partner->other_ws_products_plants = explode("|", $partner->other_ws_products_plants);
			update_field("field_field_56c172d9e5425", $partner->other_ws_products_plants, $user_id);
			$partner->ws_products_ornamentals = explode("|", $partner->ws_products_ornamentals);
			update_field("field_field_56c172d6e5424", $partner->ws_products_ornamentals, $user_id);
			$partner->other_ws_products_ornamentals = explode("|", $partner->other_ws_products_ornamentals);
			update_field("field_field_56c172d5e5423", $partner->other_ws_products_ornamentals, $user_id);
			$partner->ws_products_syrups = explode("|", $partner->ws_products_syrups);
			update_field("field_field_56c172d3e5422", $partner->ws_products_syrups, $user_id);
			$partner->other_ws_products_syrups = explode("|", $partner->other_ws_products_syrups);
			update_field("field_field_56c172d1e5421", $partner->other_ws_products_syrups, $user_id);
			$partner->ws_products_dairy = explode("|", $partner->ws_products_dairy);
			update_field("field_field_56c17387e542c", $partner->ws_products_dairy, $user_id);
			$partner->other_ws_products_dairy = explode("|", $partner->other_ws_products_dairy);
			update_field("field_field_56c17385e542b", $partner->other_ws_products_dairy, $user_id);
			$partner->ws_products_meat = explode("|", $partner->ws_products_meat);
			update_field("field_field_56c17384e542a", $partner->ws_products_meat, $user_id);
			$partner->other_ws_products_meat = explode("|", $partner->other_ws_products_meat);
			update_field("field_field_56c17383e5429", $partner->other_ws_products_meat, $user_id);
			$partner->ws_products_poultry = explode("|", $partner->ws_products_poultry);
			update_field("field_field_56c17381e5428", $partner->ws_products_poultry, $user_id);
			$partner->other_ws_products_poultry = explode("|", $partner->other_ws_products_poultry);
			update_field("field_field_56c1737fe5427", $partner->other_ws_products_poultry, $user_id);
			$partner->ws_products_agritourism = explode("|", $partner->ws_products_agritourism);
			update_field("field_field_56c173dce5432", $partner->ws_products_agritourism, $user_id);
			$partner->other_ws_products_agritourism = explode("|", $partner->other_ws_products_agritourism);
			update_field("field_field_56c173dae5431", $partner->other_ws_products_agritourism, $user_id);
			$partner->ws_products_fibers = explode("|", $partner->ws_products_fibers);
			update_field("field_field_56c173d8e5430", $partner->ws_products_fibers, $user_id);
			$partner->other_ws_products_fibers = explode("|", $partner->other_ws_products_fibers);
			update_field("field_field_56c173d7e542f", $partner->other_ws_products_fibers, $user_id);
			$partner->ws_products_artisinal = explode("|", $partner->ws_products_artisinal);
			update_field("field_field_56c18eefea474", $partner->ws_products_artisinal, $user_id);
			$partner->other_ws_products_artisinal = explode("|", $partner->other_ws_products_artisinal);
			update_field("field_field_56c18ef3ea475", $partner->other_ws_products_artisinal, $user_id);
			$partner->ws_products_liquids = explode("|", $partner->ws_products_liquids);
			update_field("field_field_56c18efaea477", $partner->ws_products_liquids, $user_id);
			$partner->other_ws_products_liquids = explode("|", $partner->other_ws_products_liquids);
			update_field("field_field_56c18ef8ea476", $partner->other_ws_products_liquids, $user_id);
			$partner->ws_products_educational = explode("|", $partner->ws_products_educational);
			update_field("field_field_56c18f00ea479", $partner->ws_products_educational, $user_id);
			$partner->other_ws_products_educational = explode("|", $partner->other_ws_products_educational);
			update_field("field_field_56c18effea478", $partner->other_ws_products_educational, $user_id);
			$partner->ws_products_baked = explode("|", $partner->ws_products_baked);
			update_field("field_field_56c18fda92dc8", $partner->ws_products_baked, $user_id);
			$partner->other_ws_products_baked = explode("|", $partner->other_ws_products_baked);
			update_field("field_field_56c18fd792dc7", $partner->other_ws_products_baked, $user_id);
			$partner->ws_products_seeds = explode("|", $partner->ws_products_seeds);
			update_field("field_field_56c18fd692dc6", $partner->ws_products_seeds, $user_id);
			$partner->other_ws_products_seeds = explode("|", $partner->other_ws_products_seeds);
			update_field("field_field_56c18fd592dc5", $partner->other_ws_products_seeds, $user_id);
			$partner->ws_products_misc = explode("|", $partner->ws_products_misc);
			update_field("field_field_56c18fd392dc4", $partner->ws_products_misc, $user_id);
			$partner->other_ws_products_misc = explode("|", $partner->other_ws_products_misc);
			update_field("field_field_56c18fd292dc3", $partner->other_ws_products_misc, $user_id);
		}
		//END Products
	}
}
