							...
							<div>
								<div class="page-block partner-info-block">
									<?php if ((!in_array("farm", $partner_category) && $partner_business_photo) || $partner_owner_photo): ?><div class="partner-info-right"><?php endif; ?>
										...
										<?php endif; ?>
									<?php if (((!in_array("farm", $partner_category) && !in_array("specialty", $partner_category) && !in_array("restaurant", $partner_category)) && $partner_business_photo) || $partner_owner_photo): ?></div><!-- end div.partner-info-right --><?php endif; ?>

									<?php if (((!in_array("farm", $partner_category) && !in_array("specialty", $partner_category) && !in_array("restaurant", $partner_category)) && $partner_business_photo) || $partner_owner_photo): ?>
									<div class="partner-info-left">
										<div class="owner-details">
											<?php if (in_array("farm", $partner_category) || in_array("specialty", $partner_category) || in_array("restaurant", $partner_category)) {
						...
						<div class="entry-product-information">
							...
							<div>
								<div class="page-block product-info-contents">
									<?php if ((in_array("farm", $partner_category) || in_array("specialty", $partner_category) || in_array("restaurant", $partner_category)) && $partner_business_photo): ?>
									...
									<?php if ((in_array("farm", $partner_category) || in_array("specialty", $partner_category) || in_array("restaurant", $partner_category)) && $partner_business_photo): ?><div class="product-info-right"><?php endif; ?>
